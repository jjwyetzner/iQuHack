...
![Image of the QGAN photonic architecture for the circuit w/ generator and discriminator from Wang et. al](https://github.com/jjwyetzner/iQuHack/images/photonicQGAN.png?raw=true)
